...
foreach ($updatestrokes as $updatestroke)
    ...
    public function edit($id)
    {
        ...
        ->with('hole_white', DB::table('holes')->where([['tees_id', '=', 2], ['hole_number', '=', $hole_number]])->first())
         ->with('hole_red', DB::table('holes')->where([['tees_id', '=', 1], ['hole_number', '=', $hole_number]])->first())
