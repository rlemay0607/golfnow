...
class Create2dayLeaderboardNewView extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        DB::statement("
        CREATE VIEW 2dayleaderboard_view AS
        (
        ...
        from round_holes where user_score>'0' and track_multiple_tournament_dates = '1'
            GROUP BY user_id
       )
        ");
    }
