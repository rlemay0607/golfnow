{{-- Start modal --}}
<div class="modal fade" id="golfer1Modal" 
...
<div class="modal-header">
    ...
    id="favoritesModalLabel">{{$rounds->golfer_1_name}} Notes</h4>
</div>
...
<div class="row" style="padding-top: 5px">
        <div class="table-responsive">
                <table class="table table-striped" border="1px">
                    ...
                    <tbody>
                            @foreach($golfer_1_notes as $golfer_1_note)
                    <tr>
                        
                        <td><div style="color: gray; font-size: 10px">
                                {{ Carbon\Carbon::parse($golfer_1_note->created_at)->diffForHumans()}}
                        
                        </div><div>{{$golfer_1_note->notes}}</div></td>
