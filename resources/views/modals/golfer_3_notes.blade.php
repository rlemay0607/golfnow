{{-- Start modal --}}
<div class="modal fade" id="golfer1Modal3" 
...
<div class="modal-header">
    ...
    id="favoritesModalLabel">{{$rounds->golfer_3_name}} Notes</h4>
</div>
<div class="modal-body">
        <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <form action="{{route('round.golfer_3_notes') }}" method="POST" >
                            {{csrf_field()}}
                            ...
                            <div class="form-group">
                                    ...
                                    <textarea rows="4", cols="54" id="golfer_3_notes" name="golfer_3_notes" style="resize:none, "></textarea>
                                </div>
                                <div>
...
<div class="row" style="padding-top: 5px">
        <div class="table-responsive">
                <table class="table table-striped" border="1px">
                    ...
                    <tbody>
                            @foreach($golfer_3_notes as $golfer_3_note)
                    <tr>
                        
                        <td><div style="color: gray; font-size: 10px">
                                {{ Carbon\Carbon::parse($golfer_3_note->created_at)->diffForHumans()}}
                        
                        </div><div>{{$golfer_3_note->notes}}</div></td>
