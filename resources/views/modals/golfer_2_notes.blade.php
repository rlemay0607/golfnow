{{-- Start modal --}}
<div class="modal fade" id="golfer1Modal2" 
...
<div class="modal-header">
    ...
    id="favoritesModalLabel">{{$rounds->golfer_2_name}} Notes</h4>
</div>
<div class="modal-body">
        <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <form action="{{route('round.golfer_2_notes') }}" method="POST" >
                            {{csrf_field()}}
                            ...
                            <div class="form-group">
                                    ...
                                    <textarea rows="4", cols="54" id="golfer_2_notes" name="golfer_2_notes" style="resize:none, "></textarea>
                                </div>
                                <div>
...
<div class="row" style="padding-top: 5px">
        <div class="table-responsive">
                <table class="table table-striped" border="1px">
                    ...
                    <tbody>
                            @foreach($golfer_2_notes as $golfer_2_note)
                    <tr>
                        
                        <td><div style="color: gray; font-size: 10px">
                                {{ Carbon\Carbon::parse($golfer_2_note->created_at)->diffForHumans()}}
                        
                        </div><div>{{$golfer_2_note->notes}}</div></td>
